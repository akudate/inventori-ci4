...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Tambah Barang Keluar</h5>
    </div>
    <div class="card-body">
    <?php 
    ...
    ?>
    <form method="post" action="<?= base_url('proses_tambah_barangkeluar') ?>" enctype="multipart/form-data">
        <div class="mb-2">
